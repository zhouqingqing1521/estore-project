...
<div class="content">
    <div class="contentCenter">
        <form action="/estore/orderCommit" name="orderForm" method="post">
            ...
            <div class="bigDiv">
                <div class="twoDiv">
                    ...
                    <ul class="oneUL">
                        <li>
                            <img src="${con.book.image}" class="pic">
                            <p>${con.book.name}&nbsp;&nbsp;</p>
            ...
            <div class="submit">
                <span>应付金额：<font>￥${total}</font>
                    <input type="image" src="images/21_03.png"></span>
            </div>
        </form>
    </div>
