...
<div class="empty">
    ...
    <div class="mainCenter">
        ...
        <div class="mainPro" style="height: 100%">
            <div class="aa">
                <input type="checkbox"><span id="but">自营</span>
            </div>
            <c:forEach items="${ShopCars}" var="shopcar" varStatus="status">
                <form action="/estore/shopCarUpdate" method="get">
                    <table>
                        <tbody>
                        <tr>
                            <td class="index">${status.count}</td>
                            <td>
                                <img src="${shopcar.book.image}" width="70px" height="85px" >
                                <span>
                                    ${shopcar.book.name}
                                    <br>
                                </span>
                            ...
                            <td class="index2">
                                <input type="hidden" name="bookId" value="${shopcar.book.id}">
                                <input type="text" name="num" value="${shopcar.num}"><br>
                                <span>有货</span>
                            </td>
                            <td>
                                <span>¥${shopcar.num*shopcar.book.price}</span>
                                <c:set var="total" value="${total+shopcar.num*shopcar.book.price}"></c:set>
                            </td>
                            <td>
                                <button type="submit">保存</button>
                                <button><a href="/estore/shopCarDelete?bookId=${shopcar.book.id}">取消</a> </button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
-->
        ...
        <div class="allButtom">
            ...
            <a href="/estore/shopCommit" class="caozuo">去提交</a>
